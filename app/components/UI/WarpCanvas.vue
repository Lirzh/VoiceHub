<template>
  <div class="absolute inset-0 z-0 bg-[var(--components_UI_WarpCanvas_2_0)] overflow-hidden">
    <canvas
      ref="canvasRef"
      class="w-full h-full block touch-none pointer-events-auto"
    />
    <div class="absolute inset-0 pointer-events-none bg-[radial-gradient(circle_at_center,transparent_45%,var(--components_UI_WarpCanvas_7_0)_100%)]" />
  </div>
</template>
